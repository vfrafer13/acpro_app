 ...
 * {@link EventsCalendarFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link EventsCalendarFragment#newInstance} factory method to
...
public class EventsCalendarFragment extends Fragment {
     ...
     * @return A new instance of fragment EventsCalendarFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EventsCalendarFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Calendario de eventos");

        simpleCalendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            @Override
            public void onSelectedDayChange(CalendarView view, int year, int month, int dayOfMonth) {
                Intent intent = new Intent(getContext(), MainActivity.class);
                intent.putExtra("main_pos", 7);
